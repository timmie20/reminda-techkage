  ...
  return (
    <AnimatePresence>
      {confirmed && (
        ...
        >
          {loading ? (
            <div className="relative z-20 text-base text-black md:text-lg">
              {loading}
            </div>
          ) : (
            <motion.div
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="mb-6 text-center">
                  This action cannot be undone or edited are you sure you want
                  to proceed
                </p>
                <div className="flex gap-2">
                  ...
                  >
                    {isDisabled ? (
                      <Loader size="22" color="green" stroke="2" />
                    ) : (
                      " Understood!"
                    )}
                  </button>
